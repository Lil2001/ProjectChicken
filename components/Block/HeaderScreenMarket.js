...
export default function HeaderScreenMarketComponent({ navigation, linkFirst, linkSecond, e, d }) {
    let navigationData = [
        ...
        { id: 3, name: 'CHICKS', link: 'ChickenBabyMarketScreen', link1: 'ChickenBabyBuyScreen' },
        { id: 4, name: 'OTHER', link: 'OtherSellScreen', link1: 'OtherBuyScreen' },
    ]
            ...
            <View style={styles.navDiv}>
                <View style={styles.navDivFirst}>
                    ...
                    <TouchableOpacity
                        ...
                        <View style={styles.usserTwoDiv}>
                            ...
                            <Image style={{ width: 30, height: 30, marginRight: 3 }} source={require('../../assets/images/userimage3.png')} />
                        </View>
                    </TouchableOpacity>
                </View>
                <View style={styles.navDivSecond} >
                    <View style={styles.navigation}>
                        {navigationData.map((value, index) => {
                            return (
                                <TouchableOpacity
                                    onPress={() => { goToPages(value.link) }}
                                    style={value.link === route.name || value.link1 === route.name ? styles.changeNavActive : styles.changeNav}
                                    key={index}
                                >
                ...
                <View style={styles.navDivThird}>
                    <View style={styles.divSmall}>
                        <TouchableOpacity
                            onPress={() => goToPages(e)}
                            style={route.name === 'MarketScreen' || route.name === 'RichScreenMarket' || route.name === 'ChickenBabyMarketScreen' || route.name === 'OtherSellScreen' ? styles.buttonYellow : styles.button}
                        >
                            <Text style={styles.buttonYellowText}>{linkFirst}</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() => goToPage(d)}
                    ...
                    <TouchableOpacity style={styles.buttonGray}>
                        <Text style={styles.buttonYellowText} >LOWEST PRICE</Text>
                    ...
                    <TouchableOpacity style={styles.buttonGray}>
                        ...
                        <Image source={require('../../assets/images/imgfilter.png')} />
                    </TouchableOpacity>
                </View>
            </View>
        </SafeAreaView>
